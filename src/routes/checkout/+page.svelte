<script lang="ts">
	...
	import CheckoutItemRow from '$lib/components/floating-cart/cart-item-detailed.svelte';
	...
	<div class="mx-auto max-w-6xl px-4 py-8 md:py-12">
		...
		>
			...
			{#if cart.items.length > 0}
				...
				<div class="mt-6 flex flex-col gap-4 border-t border-border/60 pt-5 sm:flex-row sm:justify-end">
					<div class="w-full space-y-2.5 rounded-xl border border-border/60 bg-muted/30 p-4 sm:w-80">
						<div class="mb-2 flex items-center gap-2 text-xs font-bold tracking-wider text-muted-foreground uppercase">
